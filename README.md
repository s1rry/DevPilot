...
| **macOS (Apple Silicon)** | `DevPilot_*_aarch64.dmg` | Для Mac на M1/M2/M3/M4. Открыть образ, перетащить в «Программы». |
...
> **Intel Mac:** отдельная сборка пока готовится и появится в следующем релизе. На Mac с Apple Silicon используйте `aarch64.dmg`.
